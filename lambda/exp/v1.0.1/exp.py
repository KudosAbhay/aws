...
#Creation Date: 30-October-2017-2017
#Updation Date: 30-October-2017
#Able to Parse multiple payloads of data from incoming payloads
#What's complete?:
...
#What's Pending?
# 1. Handling of 'None' Type values from incoming data
